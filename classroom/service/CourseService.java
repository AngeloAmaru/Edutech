...
public class CourseService {
    ...
    public CourseDTO create(CourseDTO dto) {
        ...
        if (dto.getManagerId() == null) {
            throw new ResourceNotFoundException("Manager no encontrado");
        }
        User manager = userRepo.findById(dto.getManagerId().longValue())
        ...
        User instructor = userRepo.findById(dto.getInstructorId().longValue())
